import 'mixins/data/pluralize_irregular_data.dart';
import 'mixins/data/pluralize_plural_data.dart';
import 'mixins/data/pluralize_singular_data.dart';
import 'mixins/data/pluralize_uncountable_data.dart';
import 'mixins/pluralize_utils.dart';
...
class Pluralize {
  ...
  String plural(String word) {
    return replaceWord(
        _irregularSingles, _irregularPlurals, _pluralRules, word);
  }

  /// Check if a word is plural.
  bool isPlural(String word) {
    return checkWord(_irregularSingles, _irregularPlurals, _pluralRules, word);
  }

  ///Singularize a word.
  String singular(String word) {
    return replaceWord(
        _irregularPlurals, _irregularSingles, _singularRules, word);
  }
